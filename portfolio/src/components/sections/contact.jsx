...
export const Contact = () => {
    ...
    const SERVICE_ID = "service_ruy2ka3";
    const TEMPLATE_ID = "template_rc11g09";
    const PUBLIC_KEY = "u3saQ33fJpcfcBjkc";
    ...
    className="min-h-screen flex items-center justify-center py-20">
        ...
        <div className="px-5 w-full md:w-150"> 
            ...
            <form className="space-y-6" onSubmit={handleSubmit}> 
                ...
                <div className="relative"> 
                    ...
                    name = "email" 
                    required
                    value = {formData.email} className="w-full bg-white/5 border border-white/10
                    rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"
                ...
                <div className="relative"> 
                    ...
                    required className="w-full bg-white/5 border border-white/10
                    rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"
