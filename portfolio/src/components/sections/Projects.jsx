    ...
    <div className="max-w-5xl mx-auto px-4"> 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1) transition-all">
                <h3 className="text-xl font-bold mb-1 "> LandlordHub </h3>
                <p className="text-gray-400 mb-4"> A MERN full stack property management web application. </p>

                <div className="flex flex-wrap gap-2"> 
                    {["REACT", " NODE ", "MONGODB", "EXPRESS"].map((tech,key)=> (
                        <span key={key}
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1) transition-all">
                <h3 className="text-xl font-bold mb-1 "> Fresh Start </h3>
                <p className="text-gray-400 mb-4"> An ongoing freelance initiative I founded to help small, underrepresented local businesses create or modernize their online presence </p>
